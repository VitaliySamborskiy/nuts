...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    useImg("gs://nuts-17b69.appspot.com/companies/companies_1.webp", getElement(".company-page__img"));
    useImg("gs://nuts-17b69.appspot.com/companies/companies_4.webp", getElement(".company-page-eco__img"));
    ...
    useImg("gs://nuts-17b69.appspot.com/companies/companies_3.webp", getElement(".ceo__representations-img"));
    ...
    for (let i = 0; i < galleryPreviewElement.length; i++) {
        useImg(galleryPreview[i], galleryPreviewElement[i]);
    }
