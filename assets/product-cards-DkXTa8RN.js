import{u as n,a as m,g as i,b as l}from"./main-CwHzDYgD.js";function x(r,e){let c=document.createDocumentFragment(),p=[];if(r.length===0)return e.innerHTML="<p>Сталася помилка. Або продукція відсутня</p>";for(let t of r){let s="",d="";t.imgUrl.forEach(()=>{d+='<div class="swiper-slide"><img class="product__slide" src="" alt="product img"/></div>'}),s=`${t.action||t.newProduct?`<div class ="product__card-flag ${t.action?"product__card-flag-discount":"product__card-flag-new"}">
