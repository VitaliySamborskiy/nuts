import{g as e,b as c,d as b,a as L,e as x,f as T}from"./main-DOuUIK4A.js";import{s as E,a as y,u as U}from"./phone-mask-Ds9gQdPx.js";import{u as v,a as m,c as k}from"./form-validate-DOpdnFFy.js";import{u as g,a as A}from"./querry-parameter-8F5Ngxzv.js";function B(t,r,a){t.forEach(l=>{l.addEventListener("click",()=>{l.getAttribute("data-tab")==="legal"||a.checked===!0?p(r):e(".registration__form-legal").remove()})}),a.addEventListener("change",()=>{a.checked===!0&&p(r)})}function p(t){let r="";r=`<div class="registration__radiobuttons-block">
