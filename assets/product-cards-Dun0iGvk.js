import{u as b,g as p,b as _}from"./main-BIZKFhvL.js";import{s as f}from"./swiper-BDI-ONPN.js";import{s as h}from"./local-storage-Dq6mamxl.js";function $(s,e){let a=document.createDocumentFragment(),d=[];if(s.length===0)return e.innerHTML="<p>Сталася помилка. Або продукція відсутня</p>";for(let t of s){let c="",i="";t.imgUrl.forEach(()=>{i+='<div class="swiper-slide"><img class="product__slide" src="" alt="product img" loading="lazy" width="406" height="278"/></div>'}),c=`${t.action||t.newProduct?`<div class ="base-product__flag product-page__flag ${t.action?"base-product__flag-discount":"base-product__flag-new"}">
