import{h as c,i as k,j as I,k as A,l as L,m as F,n as $,g as e,u as _,o as v,p as h,c as x,s as o,f as C,q as U}from"./main-Bm7yY8q7.js";import{u as T,a as N}from"./querry-parameter-8F5Ngxzv.js";import{u as R,s as b,a as f}from"./phone-mask-Ds9gQdPx.js";import{u,a as g}from"./form-validate-Cw3lBh7E.js";function M(a,t,n,s){a.addEventListener("click",()=>{t.classList.add(s)}),n.addEventListener("click",()=>{t.classList.remove(s)})}function y(a,t){S(t,a)}function H(a,t){B(t,a)}function S(a,t){let n="";n=`<div class="personal-cabinet__table-order-history">
                ...
                </div>`,a.innerHTML=s,_("gs://nuts-17b69.appspot.com/personal-cabinet/personal-cabinet.webp",e(".personal-cabinet__address-img")),E("addressUserLegalForm",t,n)}function E(a,t,n){u(e(".input__area","all"),e(".input__label","all")),g(e(a,"id"),e(".personal-cabinet__input","all"),{city:{void:"не вказане місто",regExp:"Назви міст не мають мати цифри в собі та інші заборонені символи"},cityLegal:{void:"не вказане місто",regExp:"Назви міст не мають мати цифри в собі та інші заборонені символи"}},{city:/[a-zа-яціїєґ\\-]+/gi,cityLegal:/[a-zа-яціїєґ\\-]+/gi},q,e(".personal-cabinet__address-button"),[e(a,"id"),t,n]),o(e(".registration__current-country","all"),e(".registration__select-country","all")),o(e(".registration__current-region","all"),e(".registration__select-region","all")),f(e(".registration__current-country"),e(".inputs-select__body-wrapper","all"),e(".registration__current-region"),e(".region")),o(e(".personal-cabinet__current-country-legal","all"),e(".personal-cabinet__select-country-legal","all")),o(e(".personal-cabinet__current-region-legal","all"),e(".personal-cabinet__select-region-legal","all"));try{f(e(".personal-cabinet__current-country-legal"),e(".personal-cabinet__body-wrapper","all"),e(".personal-cabinet__current-region-legal"),e(".region-legal"))}catch{}}let d;function w(a,t,n,s){window.location.search!==""?(a.forEach(r=>{r.classList.remove("personal-cabinet__link_active")}),p(n,t),e(d.tabButton,"id").classList.add("personal-cabinet__link_active")):p(n,t),a.forEach(r=>{r.addEventListener("click",i=>{a.forEach(l=>{l.classList.remove("personal-cabinet__link_active")}),i.currentTarget.classList.add("personal-cabinet__link_active"),T(["tabButton"],[i.currentTarget.id]),p(n,t),s.classList.remove("personal-cabinet__block-list_active")})})}function p(a,t){switch(d=N(["tabButton"],["tabButton"]),d.tabButton){case"tableOrder":y(e(".personal-cabinet__renders-area"));break;case"tableTransaction":H(e(".personal-cabinet__renders-area"));break;case"contactInformation":O(t,e(".personal-cabinet__renders-area"),a);break;case"passwordUser":Z(e(".personal-cabinet__renders-area"));break;case"addressForm":z(e(".personal-cabinet__renders-area"),t,a);break;default:y(e(".personal-cabinet__renders-area")),e("tableOrder","id").classList.add("personal-cabinet__link_active");break}}document.addEventListener("DOMContentLoaded",async function(){const a=C.getApp();_("gs://nuts-17b69.appspot.com/avatar.webp",e(".personal-cabinet__img")),setTimeout(()=>{let t=U.getUser();w(e(".personal-cabinet__link","all"),t,a,e(".personal-cabinet__block-list"))},600),M(e(".personal-cabinet__button"),e(".personal-cabinet__block-list"),e(".personal-cabinet__menu-cross"),"personal-cabinet__block-list_active"),x(e(".input__area","all")),w(e(".personal-cabinet__link","all"))});
